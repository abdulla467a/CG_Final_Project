...
void text()
{
    ...
    glColor3f(1,1,1);
    drawstring(160,130,0.0,"DIU BUS");
    glColor3f(1,1,1);
}
...
void credit()
{
    setFont(GLUT_BITMAP_HELVETICA_18);
    glColor3f(1,1,1);
    drawstring(400,55,0.0,"Developed By: Abdulla al shaykat");
    glColor3f(1,1,1);
    drawstring(400,30,0.0,"ID:182-15-2105");
    glColor3f(1,1,1);
    drawstring(400,5,0.0,"Dept of CSE, DIU");
}
...
int main(int argc, char **argv)
{
    ...
    glutCreateWindow("Road Crossing Alert System");
    initOpenGl();
